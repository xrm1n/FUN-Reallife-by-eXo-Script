...
function GUIMouseMenuItem:drawThis()
	...
	dxDrawRectangle(self.m_AbsoluteX, self.m_AbsoluteY, 2, self.m_Height,	Color.Accent) -- tocolor(0x3F, 0x7F, 0xBF, 255))
...
function GUIMouseMenuItem:getTextWidth()
	return dxGetTextWidth(self.m_Text, self:getFontSize(), self:getFont()) + 10 + (self.m_Icon and self.m_Height or 0)
end
